package org.savara.tools.switchyard.bpel.osgi;
...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.savara.tools.switchyard.bpel";
	...
	public void start(BundleContext context) throws Exception {
		...
		if (logger.isLoggable(Level.FINE)) {
			logger.fine("Switchyard BPEL tools started");
		}
	}
